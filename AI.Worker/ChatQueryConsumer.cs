...
namespace AI.Worker
{
    #pragma warning disable SKEXP0001 // Suppress experimental warnings for Semantic Kernel features
    public class ChatQueryConsumer : IConsumer<ChatQueryReceived>
    {
        ...
        public ChatQueryConsumer(
            Kernel kernel, 
            IMemoryStore memoryStore, 
            ITextEmbeddingGenerationService embeddingService, 
            ILogger<ChatQueryConsumer> logger, 
        ...
        public async Task Consume(ConsumeContext<ChatQueryReceived> context)
        {
            ...
            var searchResults = await _semanticTextMemory.SearchAsync(
                ...
                userQuery,
                limit: 2,
                minRelevanceScore: 0.75).ToListAsync();
            ...
            var finalAnswer = result.GetValue<string>();
